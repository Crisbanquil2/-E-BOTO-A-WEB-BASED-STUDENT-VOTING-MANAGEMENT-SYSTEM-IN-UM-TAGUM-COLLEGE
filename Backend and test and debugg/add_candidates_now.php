...
try {
    ...
    if (!$tableExists) {
        ...
        echo "<p>✅ Created candidates table</p>";
    }
    ...
    if ($result['count'] > 0) {
        echo "<p>✅ Found {$result['count']} existing candidates</p>";
        ...
        foreach ($candidates as $candidate) {
            echo "<li><strong>{$candidate['first_name']} {$candidate['last_name']}</strong> - {$candidate['position']} ({$candidate['course']} {$candidate['year_level']})</li>";
        }
        echo "</ul>";
        ...
        echo "<p>✅ Added {$addedCount} sample candidates</p>";
    }
    
    echo "<p><strong>Database Status:</strong> Connected successfully</p>";
